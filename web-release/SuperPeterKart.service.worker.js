...
/** @type {string} */
const CACHE_VERSION = '1738198648|47947694';
/** @type {string} */
const CACHE_PREFIX = 'SuperPeterKart-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SuperPeterKart.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SuperPeterKart.html","SuperPeterKart.js","SuperPeterKart.offline.html","SuperPeterKart.icon.png","SuperPeterKart.apple-touch-icon.png","SuperPeterKart.worker.js","SuperPeterKart.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["SuperPeterKart.wasm","SuperPeterKart.pck"];
